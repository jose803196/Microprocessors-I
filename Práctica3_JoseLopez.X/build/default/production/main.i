...
volatile unsigned int t = 100;
volatile unsigned int contador = 0;

void __attribute__((picinterrupt(("low_priority")))) lowInterrupt(void) {
    if (PIR1bits.TMR1IF) {
        PIR1bits.TMR1IF = 0;
        contador++;
    }
...
void __attribute__((picinterrupt(("high_priority")))) highInterrupt(void) {
    if (INTCONbits.INT0F) {
        t += 100;
        if (t >= 1000) {
            t = 100;
