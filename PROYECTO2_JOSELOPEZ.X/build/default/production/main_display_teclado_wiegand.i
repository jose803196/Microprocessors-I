...
# 10 "main_display_teclado_wiegand.c"
...
# 127 "./config.h"
void config (void);
# 30 "main_display_teclado_wiegand.c" 2
...
char p_imp;
char p_par;
# 31 "main_display_teclado_wiegand.c" 2
...
void dis_cerrado(){
    LATEbits.LATE0=segmentos[12];
    LATEbits.LATE1=segmentos[11];
    LATEbits.LATE2=segmentos[11];
    LATCbits.LATC1=segmentos[15];
    PORTBbits.RB4 = 1;
}
...
void verificacion(){
     ...
     if(contador_de_lectura>=5){
            ...
            if(byte_de_verif==codigo[5] && estado==1 && codigo[0]== 01){
                weeprom(codigo[0],codigo[1]);
                ...
                if(byte_de_verif==codigo[5] && estado==1 && codigo[0]== 02){
                    weeprom(codigo[0]+0x02,codigo[1]);
